...
CONSTRAINT PROJETOS FOREIGN KEY (ID_PROJETO_FORTES) REFERENCES PROEJETOS_FORTES(ID_PROJETO_FORTES)
);
...
constraint EQUIP_PROJ FOREIGN KEY (ID_EQUIP) REFERENCES EQUIPAMENTOS (ID_EQUIPAMENTO),
CONSTRAINT PROJ_EQUIP FOREIGN KEY (ID_PROJ_SOC) REFERENCES PROJETOS_SOCIAIS (ID_PROJETO_SOCIAL)
);
...
constraint PROJ_FUNCIO foreign key (ID_PROJ_SOC) REFERENCES PROJETOS_SOCIAIS (ID_PROJETO_SOCIAL),
CONSTRAINT FUNCIO_PROJ FOREIGN KEY (ID_FUNCIO) REFERENCES FUNCIONARIOS (ID_FUNCIONARIO)
);
...
constraint PROJ_MAT foreign key (ID_PROJ_SOC) REFERENCES PROJETOS_SOCIAIS (ID_PROJETO_SOCIAL),
CONSTRAINT MAT_PROJ FOREIGN KEY (ID_MAT) REFERENCES MATERIAIS (ID_MATERIAL)
);
